    ...
    <div className="body">
      <div className="relative md:w-1/2 lg:w-1/4 h-screen md:h-fit bg-white p-10 md:rounded-lg -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        <form action="">
          ...
          <h1 className="text-bold text-3xl text-center mb-5 text-mypalette-2">
            {t("welcome_back")}
          </h1>
          ...
          <div className="mt-5">
            <span className=" text-right block">
              <a href="/forgotpassword" className="text-mypalette-2 font-bold">
                {t("forgot_password")}
              </a>
            </span>
          </div>
          ...
          <Button
            className="mt-6 p-4 text-white bg-mypalette-2"
            fullWidth
          ...
          <div className="mt-5">
            <span className=" text-center block">
              {t("new_here")}{" "}
              <a href="/register" className="text-mypalette-2 font-bold">
                {t("register")}
              </a>
            </span>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <span className="text-bold text-mypalette-2">
              {t("or_continue_with_google")}
            </span>
            <Button
              size="lg"
              variant="outlined"
