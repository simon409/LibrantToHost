        ...
        <div>
          <div className="shadow-md">
            <div className="flex flex-col gap-2 pt-5 bg-white py-4 px-14 rounded-b-lg">
              <div id="name">
                <h1 className="text-2xl font-bold">{t("borrowed_books")}</h1>
                <ul>
                  <div className="">
                                    ...
                                    {book.borrow.requested ? (
                                      ...
                                      <button
                                        onClick={(e) =>
                                          RequestReturn({
                                            e: e,
                                            borrowId: book.borrow.id,
                                          })
                                        }
                                        className="px-4 py-2 bg-mypalette-4 rounded-lg text-white font-bold hover:bg-mypalette-5"
                                      >
                                        {t("return")}
                                      </button>
                                    )}
