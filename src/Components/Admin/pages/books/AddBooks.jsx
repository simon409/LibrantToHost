...
const AddBooks = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      mutate(book, {
        onSuccess: (bookID) =>
          SendMail({ book: book, subject: "New book added", bookId: bookID }),
      });
    },
  });
  ...
  const SendMail = async ({ book, subject, bookId }) => {
    console.log(
      "An email should have been sent to all users, just its an api and i didn't host it"
    );
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <MenuItem value="Accounting and financial management">
                      Accounting and financial management
                    </MenuItem>
                    <MenuItem value="Computer programming and software development">
                      Computer programming and software development
                    </MenuItem>
                    <MenuItem value="Information systems and technology">
                      Information systems and technology
                    </MenuItem>
                    <MenuItem value="Database management and design">
                      Database management and design
                    </MenuItem>
                    <MenuItem value="Networking and security">
                      Networking and security
                    </MenuItem>
                    <MenuItem value="Web development and design">
                    ...
                    <MenuItem value="Statistics and data analysis">
                      Statistics and data analysis
                    </MenuItem>
                    <MenuItem value="Mathematics for computer science.">
                    ...
                    <MenuItem value="Mystery/Thriller">
                      Mystery/Thriller
                    </MenuItem>
                    <MenuItem value="Science Fiction/Fantasy">
                      Science Fiction/Fantasy
                    </MenuItem>
                    <MenuItem value="Biography/Autobiography">
                      Biography/Autobiography
                    </MenuItem>
                    <MenuItem value="History">History</MenuItem>
                    <MenuItem value="Horror">Horror</MenuItem>
                    <MenuItem value="Self-help/Personal Development">
                    ...
                    <MenuItem value="Religious/Spiritual">
                      Religious/Spiritual
                    </MenuItem>
                    ...
                    <MenuItem value="Education/Teaching">
                      Education/Teaching
                    </MenuItem>
                  </Select>
                </FormControl>
                ...
                <label
                  htmlFor="imageInput"
                  className="text-gray-700 font-medium mb-2 block mt-6"
                >
                  Image
                </label>
                <div className="mb-4">
